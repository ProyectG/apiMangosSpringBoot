...
public class ConfigurationController extends ConfigurationDao{
	...
	public ConfigurationResponse config(@RequestHeader("Authorization") String jwt, @RequestBody Configuration input)
	{return  setConfiguration(jwt,input);}
	
	@GetMapping(value = "/getconfig", produces = MediaType.APPLICATION_JSON)
	public GetConfiguration getConfig(@RequestHeader("Authorization") String jwt) 
	{return getConf(jwt);}	
}
